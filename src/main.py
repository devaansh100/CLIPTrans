...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type = str, default = '/scratch/guptadm/models')
    parser.add_argument('--data_dir', type = str, default = '/mmfs1/data/bccv/dataset')
    ...
    parser.add_argument('--unfreeze_clip', action = 'store_true')
    ...
    parser.add_argument('--mapping_network', type = str, default = 'mlp', choices = ['mlp', 'transformer', 'hidden_mlp'])
    ...
    parser.add_argument('--use_all_langs', action = 'store_true')
